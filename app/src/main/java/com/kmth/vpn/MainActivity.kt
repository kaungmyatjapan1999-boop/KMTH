...
class MainActivity : AppCompatActivity() {
    ...
    private var serverTypes = arrayOf(
        "vless",
        "ssh_ws",
        "ssh_ws",
        "ssh_ws",
    ...
    private fun startVpnService() {
        ...
        val intent =
            Intent(
                ...
                putExtra(
                    MyVpnService.EXTRA_SERVER_NAME,
                    selectedServer
                )

                putExtra(
                    MyVpnService.EXTRA_SERVER_TYPE,
                    selectedServerType
                )

                putExtra(
                    MyVpnService.EXTRA_SERVER_CONFIG,
                    selectedServerConfig
                )
            }
    ...
    private fun applyServerArray(
        ...
        for (
            i in 0 until serverArray.length()
        ) {
